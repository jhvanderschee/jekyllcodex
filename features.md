...
Creating a fully dynamic menu is also possible, with only two includes. More info and a demo can be found here: https://github.com/jnvsor/jekyll-dynamic-menu. When you put the two files ('menulevel' and 'menushow') in your '_includes' folder you can generate a dynamic menu with the following command:
